...
export default function Home() {
  ...
  if (!sort) return; // daca nu s-a ales nimic, nu face fetch
  setLoading(true);
  ...
  const addToCart = (book: Book) => {
    ...
    // verificare daca cartea exista deja in cos
    ...
    // trigger event pentru actualizare cos
        ...
        <div style={{ textAlign: "center", marginBottom: "20px" }}>
          ...
          <select
            ...
            onChange={(e) => {
              ...
              loadBooksSorted(selectedSort); // doar cand se alege ceva
            }}
